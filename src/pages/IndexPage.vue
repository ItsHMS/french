 ...
 -->
    <div style="background: cornsilk" class="row q-py-xl">
      <div class="row q-col-gutter-y-md col-12">
        ...
        <div class="col-10 q-mr-md text-h4 row items-center">
    ...
    <div style="background: cornsilk" class="row q-py-xl">
      ...
      <div class="col-12 q-mr-md text-h5 text-center">
    ...
    <div class="row q-py-xl">
      <div class="col-12 q-mr-md q-pb-xl text-h3 text-center text-bold">
    ...
    <div
      ...
      class="row q-py-xl justify-center"
    >
